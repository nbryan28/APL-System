    ...
    Private Sub Label7_Click(sender As Object, e As EventArgs) Handles Label7.Click
        ...
        Try
            ...
            For i = 0 To job_list.Count - 1
                ...
                '/////// new procedure =========================================
                If String.Equals("ADA_INV", job_list.Item(i).ToString) = False Then
                ...
                Else
                    ...
                    check_cmd1.Parameters.Clear()
                    check_cmd1.Parameters.AddWithValue("@job", job_list.Item(i))
                    check_cmd1.CommandText = "select mr_name, release_date, released_by, job , need_date from Material_Request.mr where BOM_type = 'ASM'"
