        ...
        If (result = DialogResult.Yes) Then
            ...
            Try
                ...
                If enable_mess = True Then
                    ...
                    Dim mail_n As String : mail_n = "Material Request Revision for Project " & open_job & "  has been released" & vbCrLf & vbCrLf _
             ...
             & "Revised by: " & current_user
                    ...
                    Call Sent_mail.Sent_multiple_emails("Procurement", "Material Request Revision has been Released for Project " & open_job, mail_n)
                    Call Sent_mail.Sent_multiple_emails("Procurement Management", "Material Request Revision has been Released for Project " & open_job, mail_n)
                    Call Sent_mail.Sent_multiple_emails("Inventory", "Material Request Revision has been Released for Project " & open_job, mail_n)
                    Call Sent_mail.Sent_multiple_emails("General Management", "Material Request Revision has been Released for Project " & open_job, mail_n)
                    ...
                    Call Form1.get_email_list(open_job, emails_addr)
