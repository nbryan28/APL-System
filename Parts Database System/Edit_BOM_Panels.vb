...
Public Class Edit_BOM_Panels
            ...
            Try
                ...
                For i = 0 To assem_grid.Rows.Count - 1
                    ...
                    If String.IsNullOrEmpty(assem_grid.Rows(i).Cells(0).Value) = False Then
                        ...
                        check_cmd.Parameters.AddWithValue("@mr_name", my_job & "_Assembly_" & assem_grid.Rows(i).Cells(0).Value)
                        check_cmd.CommandText = "select * from Material_Request.mr where mr_name = @mr_name"
                        check_cmd.Connection = Login.Connection
                        check_cmd.ExecuteNonQuery()
                        ...
                        If exist_c = False Then
                            ...
                            main_cmd.Parameters.AddWithValue("@mr_name", my_job & "_Assembly_" & assem_grid.Rows(i).Cells(0).Value)
                            ...
                            If IsNumeric(assem_grid.Rows(i).Cells(5).Value) = True And assem_grid.Rows(i).Cells(0).Value Is Nothing = False Then
                                ...
                                Create_cmd6.Parameters.AddWithValue("@mr_name", my_job & "_Assembly_" & assem_grid.Rows(i).Cells(0).Value)
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        If assem_grid.SelectedRows.Count > 0 Then
            For Each r As DataGridViewRow In assem_grid.SelectedRows
                Try
                    assem_grid.Rows.Remove(r)
                Catch ex As Exception
                    MessageBox.Show("This row cannot be deleted")
                End Try
            Next
